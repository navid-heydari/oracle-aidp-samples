...
| Plugin | What it does |
|---|---|
| [`ask-aidp`](ask-aidp/) | Operates Oracle AI Data Platform Workbench from Claude Code through 43 MCP tools covering all 242 documented `aidp-cli` commands, 257 OCI-signed REST operations, native SDK workspace and Git actions, agents, AI Compute, notebooks, workflows, catalogs, schemas, tables, bundles, run tracking, and log collection. |
