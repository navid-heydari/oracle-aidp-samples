---
name: snowflake-object-analyzer
...
Rough prediction of what `snowflake-migrate-job` will do:
- N cells expected to pass first-try
- M cells will likely need 1 retry (specific cells: ...)
- K cells likely to be marked PARTIAL even after 10 attempts — these need [`snowflake-fixup-cell`](../skills/snowflake-fixup-cell/SKILL.md) or manual
