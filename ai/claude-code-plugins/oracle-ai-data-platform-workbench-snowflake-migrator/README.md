...
> - **[`CUSTOMER-CONTEXT.md`](CUSTOMER-CONTEXT.md)** — the customer this is being built for
>   (customer figures removed) and the 12 design-doc assumptions
...
>   + `(customer engagement deck, not in this repository)`.
